...
export const approveOrder      = (id, data = {}) => client.post(`/orders/${id}/approve`, data)
...
export const getSuggestions    = (partyId)   => client.get(`/orders/suggestions/${partyId}`)
export const resubmitOrder     = (id, data)  => client.put(`/orders/${id}/resubmit`, data)
