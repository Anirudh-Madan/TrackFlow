  ...
  const renderNavItems = () => {
      ...
      return (
        <>
          ...
          <SidebarGroup label="Fulfilment" collapsed={sidebarCollapsed}>
            <SidebarItem to="/im/pipeline" icon={GitBranch} label="Pipeline" collapsed={sidebarCollapsed} />
            <SidebarItem to="/im/workers" icon={Users} label="Dispatch Workers" collapsed={sidebarCollapsed} />
            <SidebarItem to="/im/requests" icon={Inbox} label="Part Requests" collapsed={sidebarCollapsed} />
    ...
    if (roleName === 'sales_manager') {
      return (
        <>
          <SidebarGroup label="Overview" collapsed={sidebarCollapsed}>
            <SidebarItem to="/sm/dashboard" icon={LayoutDashboard} label="Dashboard" collapsed={sidebarCollapsed} />
          </SidebarGroup>

          <SidebarGroup label="Sales" collapsed={sidebarCollapsed}>
            <SidebarItem to="/sm/orders/new" icon={Plus} label="New Order" collapsed={sidebarCollapsed} />
          ...
          <SidebarGroup label="System" collapsed={sidebarCollapsed}>
            <SidebarItem to="/sm/notifications" icon={Bell} label="Notifications" badge={unreadCount} collapsed={sidebarCollapsed} />
          </SidebarGroup>
        </>
      );
    }
